...
def info():
    ...
    click.echo("  - tools: Install, inspect, and verify managed external tools")
    click.echo(
...
def tools_status():
    ...
    click.echo(f"ToolCrate home: {binary_manager._data_dir()}")
...
def tools_install(selected_tools):
    ...
    for tool_name in selected:
        ...
        except Exception as exc:  # noqa: BLE001 - CLI boundary should print readable errors.
