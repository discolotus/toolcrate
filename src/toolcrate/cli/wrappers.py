...
def run_slsk():
    ...
    local_binary_paths = [
        ...
        root_dir / "src" / "slsk-batchdl" / "bin" / "osx-arm64" / "sldl",  # Self-built binary path (macOS ARM64)
    ]
...
def run_shazam():
    ...
    # Not found
    click.echo("Error: shazam-tool not found. Please run setup_tools.sh to install dependencies.")
    sys.exit(1)
