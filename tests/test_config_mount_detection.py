...
class TestMountDetection:
    ...
    def test_no_existing_docker_compose(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            print_calls = [str(call) for call in mock_print.call_args_list]
            assert any("No existing docker-compose.yml found" in call for call in print_calls)
    ...
    def test_container_stop_error_handling(self, mock_subprocess):
        ...
        with patch('builtins.print') as mock_print:
            ...
            print_calls = [str(call) for call in mock_print.call_args_list]
            assert any("Warning: Could not stop containers" in call for call in print_calls)
