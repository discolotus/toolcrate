...
class TestConsoleScripts:
    ...
    def test_toolcrate_script_exists(self):
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-c", "import toolcrate.cli.main; toolcrate.cli.main.main"],
                capture_output=True,
                text=True,
                timeout=10
            )
    ...
    def test_slsk_tool_script_exists(self):
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-c", "import toolcrate.cli.wrappers; print('import successful')"],
                capture_output=True,
                text=True,
                timeout=10
            )
...
class TestEndToEndWorkflows:
    ...
    def test_slsk_wrapper_help_workflow(self, mock_exit, mock_echo):
        ...
        with patch('toolcrate.cli.wrappers.get_project_root') as mock_root, \
