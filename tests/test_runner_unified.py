"""Unified test runner for ToolCrate tests (Python + Shell)."""
...
def print_usage():
    ...
    print("=" * 40)
    print("Usage: python test_runner_unified.py [command]")
    print()
    print("Commands:")
    ...
    print()
    print("Examples:")
    print("  python test_runner_unified.py all")
    print("  python test_runner_unified.py python")
    print("  python test_runner_unified.py shell")
    print("  python test_runner_unified.py module:wrappers")
    print("  python test_runner_unified.py coverage")
